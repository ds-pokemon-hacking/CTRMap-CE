...
public class Revisions {
	public static final int REV_CURRENT = 23;
	public static final int REV_CURRENT_BW_COMPAT = 23;
	...
	public static final int REV_VERTEX_MORPHS = 23;		//Multiple vertex arrays + morphs per mesh support
